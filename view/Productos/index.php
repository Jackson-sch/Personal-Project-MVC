...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4-4.6.0/jszip-2.5.0/b-2.2.2/b-colvis-2.2.2/b-html5-2.2.2/b-print-2.2.2/datatables.min.css"/>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        ...
        <p class="mg-b-0">Desde esta ventana podra dar mantenimineto a productos.</p>
      </div>
      ...
      <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
          ...
          <div class="table-wrapper">
            <table id="dataProductos" class="table display responsive">
              <thead>
                <tr>
                  <th>Codigo</th>
                  <th>Nombre</th>
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4-4.6.0/jszip-2.5.0/b-2.2.2/b-colvis-2.2.2/b-html5-2.2.2/b-print-2.2.2/datatables.min.js"></script>
